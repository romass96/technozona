                        ...
                        <div class="box-body">
                            <div class="btn-toolbar" role="toolbar">
                                <div class="btn-group">
                                    ...
                                    <button type="button" id="deleteButton" disabled onclick="deleteManager()" class="btn btn-default">
                            ...
                            <table class="table table-bordered table-hover" id="managerList">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Фамилия</th>
...
<div class="modal fade" id="manager" tabindex="-1" role="dialog" aria-labelledby="modalTitle" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="addManager" type="button" onclick="addManager()" class="btn btn-primary">Добавить</button>
                <button id="updateManager" type="button" onclick="updateManager()" class="btn btn-primary">Обновить</button>
            </div>
        </div>
    </div>
</div>
...
<script src="<c:url value="/resources/js/admin/managers.js"/>"></script>
